...
import Audi_All_Brands from './Audi_all_brands'
            ...
            <div className="tab-content" id="pills-tabContent">
                ...
                <div className="tab-pane fade show active" id="pills-Periodic" role="tabpanel" aria-labelledby="pills-Periodic-tab" tabIndex="0">
                        ...
                        <div className="col-lg-8 col-md-11 col-sm-12" style={{overflow:"scroll", scrollbarWidth:"thin", height:"550px"}}>
                            ...
                            <div className="row mb-5">
                                ...
                                <div className="col bg-white p-4 ms-4" style={{position:"relative"}}>
                                    ...
                                    <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{position:"absolute", left:"50%", top:"95%"}}  onClick={() => addcart("Audi","Q3 Petrol","Basic Car Service","3200")}>Add To Cart +</button>
                                </div>
                            </div>
                            ...
                            <div className="row mb-5">
                                ...
                                <div className="col bg-white p-4 ms-4" style={{position:"relative"}}>
                                    ...
                                    <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{position:"absolute", left:"50%", top:"95%"}}  onClick={() => addcart("Audi","Q3 Petrol","Standard Car Service","4299")}>Add To Cart +</button>
                                </div>
                            </div>
                            ...
                            <div className="row mb-5">
                                ...
                                <div className="col bg-white p-4 ms-4" style={{position:"relative"}}>
                                    ...
                                    <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{position:"absolute", left:"50%", top:"95%"}}  onClick={() => addcart("Audi","Q3 Petrol","Comprehensive  Car Service","5501")}>Add To Cart +</button>
                                </div>
                            </div>
                        ...
                        <div className="col-lg-4 col-md-11 col-sm-12">
                            <div className='bg-white py-4 px-4 m-0 my-5 shadow-lg'>
                                ...
                                <div className='row bg-secondary-subtle border border-secondary rounded-1 mb-4'>
                                    <img src="/Major_Brand/Audi/q3.jpg" className='col-3 bg-white my-4 ms-4 rounded-3' style={{width: "100px", height: "60px"}} alt="" />
                                    <div className='col mt-4 mb-3 ms-1'>
                                        <p className='fs-5 fw-bold mb-0'>Audi</p>
                                        <p className='mb-0 text-secondary' style={{fontSize:"small"}}><span className='fw-bold text-black'>Q3 </span>Petrol</p>
                    ...
                    <div className="row py-5">
                        <p className='fs-2 mb-4'>Why Choose VehicleCare for Periodic Car Services in Gurgaon for Your Audi Q3 Petrol?</p>
                        <p className='fs-4 fw-bold mb-2'>Why Periodic Service is Essential for Your Audi Q3:</p>
                        <p className='mb-0 ms-3 text-secondary'>1. Ensures optimal performance and longevity for Your Q3 Petrol Car</p>
                        ...
                        <p className='mb-4 ms-3 text-secondary'>6. Boosts resale value with a well-maintained Audi Q3 Petrol Car.</p>
                        <p className='fs-4 fw-bold mb-2'>Our Service Packages:</p>
                        <p className='mb-0 text-secondary'><span className='fw-bold' style={{color:"#ff0000"}}>Basic Car Service - </span>Essential services to keep your Q3 running smoothly.</p>
                        ...
                        <p className='fs-4 fw-bold mb-2'>Why VehicleCare Stands Out for Your Audi Q3 Petrol?</p>
                        <p className='text-secondary'>Skilled professionals, genuine parts, and top-quality service of your Audi Q3 Car. Satisfaction is guaranteed, with warranties and high-tech tools for all services.From AC gas recharging to wheel balancing, we deliver happiness with care.</p>
                    </div>
                        ...
                        <div className="accordion py-2" id="accordionExample">
                            ...
                            <h2 className="accordion-header">
                                <button className="accordion-button fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                    What is the recommended frequency for servicing my Audi Q3 in Gurgaon with VehicleCare?
                                </button>
                            </h2>
                            <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body p-4">
                                    VehicleCare recommends servicing your Audi Q3 in Gurgaon at least once a year or after every 10,000 km, whichever comes first, to maintain your vehicle's optimal performance.
                                </div>
                            </div>
                            </div>
                            ...
                            <h2 className="accordion-header">
                                ...
                                Do I need to service my Audi Q3 car even if it's relatively new in Gurgaon?
                                </button>
                            </h2>
                            ...
                            <h2 className="accordion-header">
                                ...
                                What does a periodic car service for my Audi Q3 include in Gurgaon?
                                </button>
                            </h2>
                            <div id="collapseFour" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body p-4">
                                VehicleCare's Audi Q3 service in Gurgaon includes a comprehensive inspection, fluid checks, filter replacements, brake inspection, tire rotation, and other essential tasks outlined in the manufacturer's service schedule.
                                </div>
                            </div>
                            </div>
                            ...
                            <h2 className="accordion-header">
                                ...
                                How long does a typical Audi Q3 service at VehicleCare in Gurgaon take?
                                </button>
                            </h2>
                            <div id="collapseFive" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body p-4">
                                The duration may vary for every car, but on average, a periodic service for a Audi Q3 at VehicleCare in Gurgaon takes around 3 to 4 hours. However, this can change based on additional repairs or any other services needed.
                                </div>
                            </div>
                            </div>
                            ...
                            <h2 className="accordion-header">
                                ...
                                How to know if my Audi Q3 needs standard service or comprehensive service in Gurgaon?
                                </button>
                            </h2>
                            ...
                            <h2 className="accordion-header">
                                ...
                                What makes VehicleCare's Audi Q3 periodic service unique from Audi authorised service centres in Gurgaon?
                                </button>
                            </h2>
                            <div id="collapseSeven" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body p-4">
                                VehicleCare in Gurgaon is simple, pocket-friendly, efficient, and reliable. You can book a service for your Audi Q3 from the comfort of your home, office, or anywhere. The pick-up and drop location is your choice, and you get great deals and discounts every time you opt for a service from VehicleCare. Just book a service through the VehicleCare app or website and relax.
                                </div>
                            </div>
                            </div>
                            ...
                            <h2 className="accordion-header">
                                ...
                                Is there a warranty on the Audi Q3 periodic service from VehicleCare in Gurgaon?
                                </button>
                            </h2>
                            <div id="collapseEight" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body p-4">
                                VehicleCare offers a limited warranty on parts and labour for the services performed during the periodic maintenance of your Audi Q3 in Gurgaon.
                                </div>
                            </div>
                            </div>
                            ...
                            <h2 className="accordion-header">
                                ...
                                How do I know that VehicleCare uses genuine parts for my Audi Q3 car service in Gurgaon?
                                </button>
                            </h2>
                            ...
                            <h2 className="accordion-header">
                                ...
                                How can I check the status of my Audi Q3 service at VehicleCare in Gurgaon?
                                </button>
                            </h2>
                            <div id="collapseTen" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                <div className="accordion-body p-4">
                                VehicleCare provides regular updates during the service process, and you can contact our 24x7 customer support directly for real-time information about your Audi Q3's service status or track your service on the VehicleCare app or through WhatsApp in Gurgaon.
                                </div>
                            </div>
                            </div>
                ...
                <div className="tab-pane fade" id="pills-Denting" role="tabpanel" aria-labelledby="pills-Denting-tab" tabIndex="0">
                              ...
                              <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Bonnet","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Boot","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Laft Fender","2400")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Right Fender","2400")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Front Bumper","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Left Front Door","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Right Front Door","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Left Quarter Panel","2400")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Right Quarter Panel","2400")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Rear Bumper","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Left Rear Door","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Right Rear Door","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Roof","3500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Left Running Board","2400")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Right Running Board","2400")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Full Body","23500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                          ...
                          <div className="row py-5">
                              <p className='fs-2 mb-4'>Why Choose VehicleCare for Denting Painting in Gurgaon for Your Audi Q3 Petrol?</p>
                              <p className='fs-4 fw-bold mb-2'>Why Fix Dents of Your Audi Q3 Petrol?</p>
                              <p className='mb-0 ms-3 text-secondary'>1. <span className='fw-bold' style={{color:"#ff0000"}}>Preserve Resale Value - </span>Dents lower your Audi Q3 resale value.</p>
                              ...
                              <p className='fs-4 fw-bold mb-2'>Why VehicleCare Stands Out for Your Audi Q3 Petrol?</p>
                              <p className='mb-0 ms-3 text-secondary'>1. Denting-painting services are available for all car models including Audi Q3 Petrol in Gurgaon.</p>
                          ...
                          <div className="row py-5">
                              ...
                              <div className="accordion py-2" id="accordionExample">
                                  ...
                                  <div className="accordion-item my-3">
                                      ...
                                      <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                          <div className="accordion-body p-4">
                                          VehicleCare in Gurgaon specialises in denting and painting services for a wide range of vehicles, including cars, SUVs, and luxury models like Audi.
                                          </div>
                                      </div>
                                  </div>
                                  ...
                                  <div className="accordion-item my-3">
                                      <h2 className="accordion-header">
                                          <button className="accordion-button fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                          What kind of damages can be repaired on my Audi Q3 at VehicleCare workshops in Gurgaon?
                                          </button>
                                      </h2>
                                      <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                          <div className="accordion-body p-4">
                                          VehicleCare Gurgaon workshops are equipped to repair any kind of sheet metal damage in your car, like dents and tear, or paint damages like scratches, blemishes, cuffs, or paint chips, plastic or fibre paint damage on your Audi Q3.
                                          </div>
                                      </div>
                                  </div>
                                  ...
                                  <div className="accordion-item my-3">
                                      <h2 className="accordion-header">
                                          <button className="accordion-button fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                          Can VehicleCare match the paint color exactly to my Audi Q3 in Gurgaon?
                                          </button>
                                      </h2>
                                      <div id="collapseFour" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                          <div className="accordion-body p-4">
                                          We use premium industry-grade paints over grade A primer and specialised color palettes approved by Audi in Gurgaon, which offer an exact match with your original Audi Q3 color.
                                          </div>
                                      </div>
                                  </div>
                                  ...
                                  <div className="accordion-item my-3">
                                      ...
                                      <div id="collapseFive" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                          <div className="accordion-body p-4">
                                          A single panel on your Audi Q3 car in Gurgaon may take up to 24-48 hours due to the elaborative procedures involved, which is followed by different steps like rubbing, polishing, and buffing. A full car body denting and painting for a Audi Q3 in Gurgaon may take up to a week depending upon different other factors.
                                          </div>
                                      </div>
                                  </div>
                                  ...
                                  <div className="accordion-item my-3">
                                      <h2 className="accordion-header">
                                          <button className="accordion-button fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                          Is VehicleCare equipped to handle specific requirements for high-end vehicles like Audi during denting and painting services in Gurgaon?
                                          </button>
                                      </h2>
                                      <div id="collapseNine" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                          <div className="accordion-body p-4">
                                          Yes, VehicleCare in Gurgaon has expertise in handling high-end vehicles, including Audi. Our technicians are trained to meet the specific standards and requirements of luxury car repairs.
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Alternator","12000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Alternator Belt","500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Arm Bush","500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Axle Left","4500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Axle Right","4500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Brake Shoe","1200")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Battery","4000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Belt Complete","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Blower","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Blower Housing","1500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Brake Hoses","800")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Brake Pads","2000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","C-Mount Rear","1800")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Caliper Pin","600")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Catalytic Converter","10000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Clutch Assembly","6500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Clutch Magnet","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Coil Spring","1200")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Condensor","5000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Control ARM Left","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Control ARM Right","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Control Panel","1500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Cooling Coil","4000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Crank Case Gasket","900")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Discharge Pipe","1000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Duct","1200")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","EGR Valve Gasket","2000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Exhaust Manifold Gasket","1000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Exhaust Pipe Gasket","800")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Expansion Valve","6000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Flywheel","6000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Front Left Shocker","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Front Mounting Left","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Front Mounting Right","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Front Right Shocker","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Fuel Hoses","1000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Fuel Pipe","1000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Fuel Pump Module","4500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Fuel Rail","2000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Fuel Tank","8000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Head Gasket","1500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Head Lamp Left","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Head Lamp Right","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Heating Core","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Intake Manifold Gasket","1200")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Jumping Rod Bush","800")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Link Rod","1500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Master Cylinder","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Muffler","4000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Oil Cooler Gasket","900")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","ORVM Cap","800")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Power Steering Pump Gasket","1000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Rack End","1500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Rear Left Shocker","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Rear Right Shocker","3000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Resistor","600")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Shocker Mount","1200")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Side View Mirror Left","2000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Side View Mirror Right","2000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Silencer","5000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Steering Rack Assembly","7000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Sub Mirror","1200")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Suction Pipe","1500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Tail Lamp Left","1600")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Tail Lamp Right","1600")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Tappet Packaging Cover","800")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Throttle Body Cleaning","1500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Tie Rod","1200")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Timing Belt","2000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Washer Pipe","800")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Washer Reservoir","1500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Water Pump Belt","1200")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Wiper Blades","500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Wiper Linkage","800")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Wiper Motor","2700")}>Add To Cart +</button>
                                      </div>
                                  </div>
                              ...
                              <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "90%" }} onClick={() => addcart("Audi","Q3 Petrol","AC Gas CheckUp","600")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","AC Service","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","AC Compressor","8000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "85%" }} onClick={() => addcart("Audi","Q3 Petrol","AC Gas","1200")}>Add To Cart +</button>
                                      </div>
                                  </div>
                              ...
                              <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Wheel Alignment","500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Wheel Balencing","500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                              ...
                              <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Car Wash","500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Car Interior Dry Cleaning","1600")}>Add To Cart +</button>
                                      </div>
                                  </div>
                              ...
                              <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Complate Car Detailing","7000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Ceramic Coating","25000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","PPF - Paint Protection Film","30000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Rubbing Polishing","1500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Teflon Coating","5000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Anti Rust Coating","2500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                              ...
                              <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Car Scanning","1500")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Other Diagnosis","1000")}>Add To Cart +</button>
                                      </div>
                                  </div>
                                  ...
                                  <div className="row mb-5">
                                      ...
                                      <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                          ...
                                          <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Audi","Q3 Petrol","Tyre","3700")}>Add To Cart +</button>
                                      </div>
                                  </div>
