...
import Toyota_All_Brands from './Toyota_all_brands'
             ...
             <div className="tab-content" id="pills-tabContent">
                 ...
                 <div className="tab-pane fade show active" id="pills-Periodic" role="tabpanel" aria-labelledby="pills-Periodic-tab" tabIndex="0">
                         ...
                         <div className="col-lg-8 col-md-11 col-sm-12" style={{overflow:"scroll", scrollbarWidth:"thin", height:"550px"}}>
                             ...
                             <div className="row mb-5">
                                 ...
                                 <div className="col bg-white p-4 ms-4" style={{position:"relative"}}>
                                     ...
                                     <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{position:"absolute", left:"50%", top:"95%"}}  onClick={() => addcart("Toyota","Innova Petrol","Basic Car Service","3200")}>Add To Cart +</button>
                                 </div>
                             </div>
                             ...
                             <div className="row mb-5">
                                 ...
                                 <div className="col bg-white p-4 ms-4" style={{position:"relative"}}>
                                     ...
                                     <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{position:"absolute", left:"50%", top:"95%"}}  onClick={() => addcart("Toyota","Innova Petrol","Standard Car Service","4299")}>Add To Cart +</button>
                                 </div>
                             </div>
                             ...
                             <div className="row mb-5">
                                 ...
                                 <div className="col bg-white p-4 ms-4" style={{position:"relative"}}>
                                     ...
                                     <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{position:"absolute", left:"50%", top:"95%"}}  onClick={() => addcart("Toyota","Innova Petrol","Comprehensive  Car Service","5501")}>Add To Cart +</button>
                                 </div>
                             </div>
                         ...
                         <div className="col-lg-4 col-md-11 col-sm-12">
                             <div className='bg-white py-4 px-4 m-0 my-5 shadow-lg'>
                                 ...
                                 <div className='row bg-secondary-subtle border border-secondary rounded-1 mb-4'>
                                     <img src="/Major_Brand/Toyota/innova.jpg" className='col-3 bg-white my-4 ms-4 rounded-3' style={{width: "100px", height: "60px"}} alt="" />
                                     <div className='col mt-4 mb-3 ms-1'>
                                         <p className='fs-5 fw-bold mb-0'>Toyota</p>
                                         <p className='mb-0 text-secondary' style={{fontSize:"small"}}><span className='fw-bold text-black'>Innova </span>Petrol</p>
                     ...
                     <div className="row py-5">
                         <p className='fs-2 mb-4'>Why Choose VehicleCare for Periodic Car Services in Gurgaon for Your Toyota Innova Petrol?</p>
                         <p className='fs-4 fw-bold mb-2'>Why Periodic Service is Essential for Your Toyota Innova:</p>
                         <p className='mb-0 ms-3 text-secondary'>1. Ensures optimal performance and longevity for Your Innova Petrol Car</p>
                         ...
                         <p className='mb-4 ms-3 text-secondary'>6. Boosts resale value with a well-maintained Toyota Innova Petrol Car.</p>
                         <p className='fs-4 fw-bold mb-2'>Our Service Packages:</p>
                         <p className='mb-0 text-secondary'><span className='fw-bold' style={{color:"#ff0000"}}>Basic Car Service - </span>Essential services to keep your Innova running smoothly.</p>
                         ...
                         <p className='fs-4 fw-bold mb-2'>Why VehicleCare Stands Out for Your Toyota Innova Petrol?</p>
                         <p className='text-secondary'>Skilled professionals, genuine parts, and top-quality service of your Toyota Innova Car. Satisfaction is guaranteed, with warranties and high-tech tools for all services.From AC gas recharging to wheel balancing, we deliver happiness with care.</p>
                     </div>
                         ...
                         <div className="accordion py-2" id="accordionExample">
                             ...
                             <h2 className="accordion-header">
                                 <button className="accordion-button fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                     What is the recommended frequency for servicing my Toyota Innova in Gurgaon with VehicleCare?
                                 </button>
                             </h2>
                             <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                 <div className="accordion-body p-4">
                                     VehicleCare recommends servicing your Toyota Innova in Gurgaon at least once a year or after every 10,000 km, whichever comes first, to maintain your vehicle's optimal performance.
                                 </div>
                             </div>
                             </div>
                             ...
                             <h2 className="accordion-header">
                                 ...
                                 Do I need to service my Toyota Innova car even if it's relatively new in Gurgaon?
                                 </button>
                             </h2>
                             ...
                             <h2 className="accordion-header">
                                 ...
                                 What does a periodic car service for my Toyota Innova include in Gurgaon?
                                 </button>
                             </h2>
                             <div id="collapseFour" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                 <div className="accordion-body p-4">
                                 VehicleCare's Toyota Innova service in Gurgaon includes a comprehensive inspection, fluid checks, filter replacements, brake inspection, tire rotation, and other essential tasks outlined in the manufacturer's service schedule.
                                 </div>
                             </div>
                             </div>
                             ...
                             <h2 className="accordion-header">
                                 ...
                                 How long does a typical Toyota Innova service at VehicleCare in Gurgaon take?
                                 </button>
                             </h2>
                             <div id="collapseFive" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                 <div className="accordion-body p-4">
                                 The duration may vary for every car, but on average, a periodic service for a Toyota Innova at VehicleCare in Gurgaon takes around 3 to 4 hours. However, this can change based on additional repairs or any other services needed.
                                 </div>
                             </div>
                             </div>
                             ...
                             <h2 className="accordion-header">
                                 ...
                                 How to know if my Toyota Innova needs standard service or comprehensive service in Gurgaon?
                                 </button>
                             </h2>
                             ...
                             <h2 className="accordion-header">
                                 ...
                                 What makes VehicleCare's Toyota Innova periodic service unique from Toyota authorised service centres in Gurgaon?
                                 </button>
                             </h2>
                             <div id="collapseSeven" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                 <div className="accordion-body p-4">
                                 VehicleCare in Gurgaon is simple, pocket-friendly, efficient, and reliable. You can book a service for your Toyota Innova from the comfort of your home, office, or anywhere. The pick-up and drop location is your choice, and you get great deals and discounts every time you opt for a service from VehicleCare. Just book a service through the VehicleCare app or website and relax.
                                 </div>
                             </div>
                             </div>
                             ...
                             <h2 className="accordion-header">
                                 ...
                                 Is there a warranty on the Toyota Innova periodic service from VehicleCare in Gurgaon?
                                 </button>
                             </h2>
                             <div id="collapseEight" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                 <div className="accordion-body p-4">
                                 VehicleCare offers a limited warranty on parts and labour for the services performed during the periodic maintenance of your Toyota Innova in Gurgaon.
                                 </div>
                             </div>
                             </div>
                             ...
                             <h2 className="accordion-header">
                                 ...
                                 How do I know that VehicleCare uses genuine parts for my Toyota Innova car service in Gurgaon?
                                 </button>
                             </h2>
                             ...
                             <h2 className="accordion-header">
                                 ...
                                 How can I check the status of my Toyota Innova service at VehicleCare in Gurgaon?
                                 </button>
                             </h2>
                             <div id="collapseTen" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                 <div className="accordion-body p-4">
                                 VehicleCare provides regular updates during the service process, and you can contact our 24x7 customer support directly for real-time information about your Toyota Innova's service status or track your service on the VehicleCare app or through WhatsApp in Gurgaon.
                                 </div>
                             </div>
                             </div>
                 ...
                 <div className="tab-pane fade" id="pills-Denting" role="tabpanel" aria-labelledby="pills-Denting-tab" tabIndex="0">
                               ...
                               <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Bonnet","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Boot","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Laft Fender","2400")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Right Fender","2400")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Front Bumper","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Left Front Door","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Right Front Door","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Left Quarter Panel","2400")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Right Quarter Panel","2400")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Rear Bumper","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Left Rear Door","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Right Rear Door","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Roof","3500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Left Running Board","2400")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Right Running Board","2400")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Full Body","23500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                           ...
                           <div className="row py-5">
                               <p className='fs-2 mb-4'>Why Choose VehicleCare for Denting Painting in Gurgaon for Your Toyota Innova Petrol?</p>
                               <p className='fs-4 fw-bold mb-2'>Why Fix Dents of Your Toyota Innova Petrol?</p>
                               <p className='mb-0 ms-3 text-secondary'>1. <span className='fw-bold' style={{color:"#ff0000"}}>Preserve Resale Value - </span>Dents lower your Toyota Innova resale value.</p>
                               ...
                               <p className='fs-4 fw-bold mb-2'>Why VehicleCare Stands Out for Your Toyota Innova Petrol?</p>
                               <p className='mb-0 ms-3 text-secondary'>1. Denting-painting services are available for all car models including Toyota Innova Petrol in Gurgaon.</p>
                           ...
                           <div className="row py-5">
                               ...
                               <div className="accordion py-2" id="accordionExample">
                                   ...
                                   <div className="accordion-item my-3">
                                       ...
                                       <div id="collapseOne" className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                           <div className="accordion-body p-4">
                                           VehicleCare in Gurgaon specialises in denting and painting services for a wide range of vehicles, including cars, SUVs, and luxury models like Toyota.
                                           </div>
                                       </div>
                                   </div>
                                   ...
                                   <div className="accordion-item my-3">
                                       <h2 className="accordion-header">
                                           <button className="accordion-button fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                           What kind of damages can be repaired on my Toyota Innova at VehicleCare workshops in Gurgaon?
                                           </button>
                                       </h2>
                                       <div id="collapseTwo" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                           <div className="accordion-body p-4">
                                           VehicleCare Gurgaon workshops are equipped to repair any kind of sheet metal damage in your car, like dents and tear, or paint damages like scratches, blemishes, cuffs, or paint chips, plastic or fibre paint damage on your Toyota Innova.
                                           </div>
                                       </div>
                                   </div>
                                   ...
                                   <div className="accordion-item my-3">
                                       <h2 className="accordion-header">
                                           <button className="accordion-button fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                           Can VehicleCare match the paint color exactly to my Toyota Innova in Gurgaon?
                                           </button>
                                       </h2>
                                       <div id="collapseFour" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                           <div className="accordion-body p-4">
                                           We use premium industry-grade paints over grade A primer and specialised color palettes approved by Toyota in Gurgaon, which offer an exact match with your original Toyota Innova color.
                                           </div>
                                       </div>
                                   </div>
                                   ...
                                   <div className="accordion-item my-3">
                                       ...
                                       <div id="collapseFive" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                           <div className="accordion-body p-4">
                                           A single panel on your Toyota Innova car in Gurgaon may take up to 24-48 hours due to the elaborative procedures involved, which is followed by different steps like rubbing, polishing, and buffing. A full car body denting and painting for a Toyota Innova in Gurgaon may take up to a week depending upon different other factors.
                                           </div>
                                       </div>
                                   </div>
                                   ...
                                   <div className="accordion-item my-3">
                                       <h2 className="accordion-header">
                                           <button className="accordion-button fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseNine" aria-expanded="false" aria-controls="collapseNine">
                                           Is VehicleCare equipped to handle specific requirements for high-end vehicles like Toyota during denting and painting services in Gurgaon?
                                           </button>
                                       </h2>
                                       <div id="collapseNine" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                                           <div className="accordion-body p-4">
                                           Yes, VehicleCare in Gurgaon has expertise in handling high-end vehicles, including Toyota. Our technicians are trained to meet the specific standards and requirements of luxury car repairs.
                                           </div>
                                       </div>
                                   </div>
                               ...
                               <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Alternator","12000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Alternator Belt","500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Arm Bush","500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Axle Left","4500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Axle Right","4500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Brake Shoe","1200")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Battery","4000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Belt Complete","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Blower","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Blower Housing","1500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Brake Hoses","800")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Brake Pads","2000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","C-Mount Rear","1800")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Caliper Pin","600")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Catalytic Converter","10000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Clutch Assembly","6500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Clutch Magnet","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Coil Spring","1200")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Condensor","5000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Control ARM Left","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Control ARM Right","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Control Panel","1500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Cooling Coil","4000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Crank Case Gasket","900")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Discharge Pipe","1000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Duct","1200")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","EGR Valve Gasket","2000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Exhaust Manifold Gasket","1000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Exhaust Pipe Gasket","800")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Expansion Valve","6000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Flywheel","6000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Front Left Shocker","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Front Mounting Left","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Front Mounting Right","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Front Right Shocker","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Fuel Hoses","1000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Fuel Pipe","1000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Fuel Pump Module","4500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Fuel Rail","2000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Fuel Tank","8000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Head Gasket","1500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Head Lamp Left","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Head Lamp Right","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Heating Core","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Intake Manifold Gasket","1200")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Jumping Rod Bush","800")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Link Rod","1500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Master Cylinder","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Muffler","4000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Oil Cooler Gasket","900")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","ORVM Cap","800")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Power Steering Pump Gasket","1000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Rack End","1500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Rear Left Shocker","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Rear Right Shocker","3000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Resistor","600")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Shocker Mount","1200")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Side View Mirror Left","2000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Side View Mirror Right","2000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Silencer","5000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Steering Rack Assembly","7000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Sub Mirror","1200")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Suction Pipe","1500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Tail Lamp Left","1600")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Tail Lamp Right","1600")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Tappet Packaging Cover","800")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Throttle Body Cleaning","1500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Tie Rod","1200")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Timing Belt","2000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Washer Pipe","800")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Washer Reservoir","1500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Water Pump Belt","1200")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Wiper Blades","500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Wiper Linkage","800")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Wiper Motor","2700")}>Add To Cart +</button>
                                       </div>
                                   </div>
                               ...
                               <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "90%" }} onClick={() => addcart("Toyota","Innova Petrol","AC Gas CheckUp","600")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","AC Service","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","AC Compressor","8000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "85%" }} onClick={() => addcart("Toyota","Innova Petrol","AC Gas","1200")}>Add To Cart +</button>
                                       </div>
                                   </div>
                               ...
                               <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Wheel Alignment","500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Wheel Balencing","500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                               ...
                               <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Car Wash","500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Car Interior Dry Cleaning","1600")}>Add To Cart +</button>
                                       </div>
                                   </div>
                               ...
                               <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Complate Car Detailing","7000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Ceramic Coating","25000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","PPF - Paint Protection Film","30000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Rubbing Polishing","1500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Teflon Coating","5000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Anti Rust Coating","2500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                               ...
                               <div className="col-lg-8 col-md-11 col-sm-12" style={{ overflow: "scroll", scrollbarWidth: "thin", height: "550px" }}>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Car Scanning","1500")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Other Diagnosis","1000")}>Add To Cart +</button>
                                       </div>
                                   </div>
                                   ...
                                   <div className="row mb-5">
                                       ...
                                       <div className="col bg-white p-4 ms-4" style={{ position: "relative" }}>
                                           ...
                                           <button className='border-0 px-4 py-2 fw-bold add-to-cart' style={{ position: "absolute", left: "50%", top: "95%" }} onClick={() => addcart("Toyota","Innova Petrol","Tyre","3700")}>Add To Cart +</button>
                                       </div>
                                   </div>
